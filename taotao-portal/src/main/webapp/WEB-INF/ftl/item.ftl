				...
				<div class="spec-items">
					<ul class="lh">   
						<#list images as image>  
								<#if image_index == 0>
									<li>
										<img data-img="1" class="img-hover"  alt="${item.title}" src="${image}" width="50" height="50" data-url="${image}">
									</li>
								<#else> 
									<li>
										<img data-img="1" alt="${item.title}" src="${image}" width="50" height="50" data-url="${image}">
									</li>
								</#if>
						</#list> 
					</ul>
	...
	<li clstag="shangpin|keycount|product|zhinan" data-widget='tab-item'><a href='javascript:;'>京博士</a></li>
			...
			<div class="mc hide" data-widget="tab-content" id="product-detail-2">
				<table border="1" align="center">
					<#list itemParamitem as item>
						 <tr>
							<th align="center" colspan="2">${item.group}</th>
						 </tr>
						 <#list item.params as detail>
						 	<tr>
